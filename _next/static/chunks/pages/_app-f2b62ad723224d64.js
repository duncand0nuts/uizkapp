...
/* harmony import */ var _reactCOIServiceWorker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9639);
...
function loadCOIServiceWorker() {
    if ( true && window.location.hostname != "localhost") {
        ...
        coi.setAttribute("src", "/uizkapp/coi-serviceworker.min.js"); // update if your repo name changes for npm run deploy to work successfully
